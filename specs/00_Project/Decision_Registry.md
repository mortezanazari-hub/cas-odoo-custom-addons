...
| `DEC-V7-009-ROUTE-CAPABILITY` | Route و Capability عمومی | Workspace/Security | Cycle 7 | [`DEC-009`](../04_Decisions/DEC-009-Workspace-Route-And-Capability-Expansion.md) | Partially Superseded | Gap Identified | Pending Revalidation | Route مستقل Search/History و `history.read` Superseded | `DEC-V8-016-SEARCH-HISTORY` + Cycle 9 Navigation |
