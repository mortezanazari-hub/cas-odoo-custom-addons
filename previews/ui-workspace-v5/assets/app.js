  ...
  function renderHome(){
    ...
    return `<div class="page employee-workspace-v5">
      <section class="briefing-hero">
        <div class="briefing-copy">
          ...
          <div class="briefing-lines">
            ...
            <button data-action="open-calendar-day"><span class="briefing-bullet">◷</span><strong>اولین جلسه ساعت ۱۱:۰۰ است</strong><small>جلسه هماهنگی عملیات</small></button>
        ...
        <div class="briefing-side">
          ...
          <button class="command-launcher" data-action="global-search"><span>⌕</span><div><strong>چه کاری می‌خواهی انجام بدهی؟</strong><small>فرم، اقدام، شخص، سند یا فرایند را جست‌وجو کن</small></div><kbd>Ctrl K</kbd></button>
        </div>
      </section>
      ...
      <section class="action-strip">
        ...
        <button data-action="open-calendar-day"><span>◷</span><div><strong>برنامه‌ریزی</strong><small>افزودن رویداد یا جلسه</small></div></button>
      ...
      <div class="command-work-grid">
        <section class="card personal-todo-card">
          ...
          <div class="card-footer"><button class="btn btn-ghost" data-action="all-personal-tasks">نمایش همه کارها</button></div>
        </section>
        ...
        <section class="card calendar-compact-card">
          ...
          <div class="card-footer"><button class="btn" data-action="open-calendar-day">بازکردن تقویم کامل</button><button class="btn btn-primary" data-action="new-calendar-event">+ رویداد جدید</button></div>
        </section>
      </div>
      ...
      <div class="workspace-bottom-grid v5-bottom">
        <section class="card personal-shortcuts"><div class="card-header"><div><h3 class="card-title">میانبرهای من</h3><div class="card-subtitle">مسیرهای پرتکرار، نه ساختار ماژول‌های پشت صحنه</div></div><button class="mini-btn" data-action="customize-workspace">⚙</button></div><div class="card-body"><div class="shortcut-grid"><button data-route="request-center"><span>◫</span><strong>درخواست‌های من</strong><small>ثبت و پیگیری</small></button><button data-route="correspondence"><span>✉</span><strong>مکاتبات</strong><small>نامه‌ها و ارجاع‌ها</small></button><button data-route="attendance-hub"><span>◴</span><strong>حضور و شیفت</strong><small>کاردکس شخصی</small></button><button data-route="my-documents"><span>▧</span><strong>اسناد مرتبط</strong><small>فایل‌ها و نسخه‌ها</small></button></div></div></section>
