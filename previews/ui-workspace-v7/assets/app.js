(() => {
  ...
  function renderMessagesPage(){
    ...
    return `<div class="page v6-page">${pageHeader("گفت‌وگوها","ارتباط مستقیم و گروهی سازمان، یکپارچه با رکوردها و جریان کار CAS.","ارتباطات سازمانی",`<button class="btn" data-action="message-search">جست‌وجو</button><button class="btn btn-primary" data-action="new-conversation">+ گفت‌وگوی جدید</button>`)}
