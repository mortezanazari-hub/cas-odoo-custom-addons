window.CAS_DATA = (() => {
  ...
  const roleCapabilities = {
    employee:["workspace.home","personal.tasks","calendar.use","discuss.use","action.read","request.create","request.track","report.daily.create","attendance.self","correspondence.self","search.global","notification.read"],
    supervisor:["team.dashboard","team.actions","team.reports","attendance.team.review","shift.team.read","approval.decide","personal.tasks","calendar.use","discuss.use","search.global","notification.read"],
    manager:["management.dashboard","team.actions","team.reports","attendance.team.review","shift.manage","approval.decide","personal.tasks","calendar.use","discuss.use","search.global","notification.read"],
    ceo:["executive.dashboard","approval.decide","organization.analytics","personal.tasks","calendar.use","discuss.use","search.global","notification.read"],
    guard:["guard.workspace","guard.event.create","guard.event.read","shift.self","report.daily.create","personal.tasks","calendar.use","discuss.use","search.global","notification.read"],
    secretariat:["secretariat.workspace","correspondence.manage","document.manage","personal.tasks","calendar.use","discuss.use","search.global","notification.read"],
    shift_planner:["shift.manage","attendance.import","personal.tasks","calendar.use","discuss.use","search.global","notification.read"],
    form_designer:["form.design","personal.tasks","calendar.use","discuss.use","search.global","notification.read"],
    workflow_designer:["workflow.design","personal.tasks","calendar.use","discuss.use","search.global","notification.read"],
    document_manager:["document.manage","ocr.manage","personal.tasks","calendar.use","discuss.use","search.global","notification.read"],
    system_admin:["admin.center","admin.users","admin.roles","admin.organization","admin.positions","admin.assignments","admin.settings","admin.audit","admin.health","technical.tools","personal.tasks","calendar.use","discuss.use","search.global","notification.read"]
  };

  const navGroups = [
    {title:"فضای کاری",items:[
      {id:"workspace",label:"میزکار",icon:"⌂",children:[
        {route:"home",label:"نمای کلی میزکار",icon:"⌂",permissions:["workspace.home"]},
        {route:"notifications-center",label:"مرکز اعلان‌ها",icon:"◔",permissions:["notification.read"],count:4}
      ]},
      {id:"communications",label:"ارتباطات",icon:"❝",children:[
      ...
      {id:"tasks",label:"کارها و درخواست‌ها",icon:"✓",children:[
      ...
      {id:"attendance",label:"حضور، شیفت و کارکرد",icon:"◷",route:"attendance-hub",permissions:["attendance.self"],children:[
        {route:"attendance-hub",label:"نمای کلی حضور و شیفت",icon:"⌂",permissions:["attendance.self"]},
        {route:"my-shifts",label:"تقویم شیفت من",icon:"◷",permissions:["attendance.self"]},
        {route:"my-attendance",label:"حضور و کارکرد من",icon:"◴",permissions:["attendance.self"]},
        {route:"shift-swaps",label:"جابه‌جایی شیفت",icon:"↔",permissions:["attendance.self"]},
        {route:"my-kardex",label:"کاردکس من",icon:"▦",permissions:["attendance.self"]},
        {route:"attendance-requests",label:"مرخصی و مأموریت",icon:"◫",permissions:["attendance.self"]},
        {route:"overtime",label:"اضافه‌کاری",icon:"＋",permissions:["attendance.self"]}
      ]},
      {id:"reports",label:"گزارش کار",icon:"✎",children:[
        {route:"work-report-new",label:"ثبت گزارش روزانه",icon:"✎",permissions:["report.daily.create"]},
        {route:"work-reports",label:"گزارش‌های من",icon:"▤",permissions:["report.daily.create"]}
      ]},
      {route:"calendar",label:"تقویم سازمانی",icon:"◷",permissions:["calendar.use"]}
    ]},
    ...
    {title:"ابزارهای تخصصی",items:[
      {id:"forms-processes",label:"فرم‌ها و فرایندها",icon:"▣",route:"forms-admin",children:[
        {route:"forms-admin",label:"مدیریت فرم‌ها",icon:"▣",permissions:["form.design"]},
        {route:"form-builder",label:"طراح دیداری فرم",icon:"✥",permissions:["form.design"]}
      ]},
      {id:"workflow-tools",label:"گردش‌کارها",icon:"⌘",route:"workflow-admin",children:[
        {route:"workflow-admin",label:"مدیریت گردش‌کار",icon:"⌘",permissions:["workflow.design"]},
        {route:"workflow-designer",label:"طراح دیداری گردش‌کار",icon:"⌁",permissions:["workflow.design"]}
      ]},
